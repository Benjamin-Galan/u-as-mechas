export const promociones = [
    ...
    },
    {
        "id": 2,
        "title": "Pedicure ",
        "description": "Manicure Tropical con esmalte de gel",
        "price": 35,
    },
    {
        "id": 3,
...
export const seasonPromo = [
    {
        ...
        "description": "Muestra tus uñas relucientes con nuestras promociones de temporada",
        "details": [
            {
                "id": 1,
                "title": "Manicure",
...
export const aboutUs = {
    ...
    'description': "En Uñas y Mechas, nos dedicamos a realzar tu belleza natural con servicios personalizados y productos de la más alta calidad. Nuestro equipo de profesionales está comprometido con brindarte la mejor experiencia.",
    'history': "Fundado en 2021, nuestro salón ha crecido para convertirse en un referente de belleza y bienestar en la ciudad, manteniendo siempre nuestro compromiso con la excelencia y la satisfacción del cliente.",
    'detalles': [
        {
            "id": 1,
